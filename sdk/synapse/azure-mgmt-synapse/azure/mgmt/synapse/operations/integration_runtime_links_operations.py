...
class IntegrationRuntimeLinksOperations(object):
    ...
    def remove(
        ...
        return deserialized
    remove.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/integrationRuntimes/{integrationRuntimeName}/removeLinks'}
