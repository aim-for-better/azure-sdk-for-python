...
from .operations.integration_runtime_interactive_queries_operations import IntegrationRuntimeInteractiveQueriesOperations
from .operations.integration_runtime_operation_results_operations import IntegrationRuntimeOperationResultsOperations
from .operations.integration_runtime_links_operations import IntegrationRuntimeLinksOperations
from .operations.integration_runtimes_operations import IntegrationRuntimesOperations
from .operations.integration_runtime_node_ip_address_operations import IntegrationRuntimeNodeIpAddressOperations
from .operations.integration_runtime_operation_status_operations import IntegrationRuntimeOperationStatusOperations
...
from .operations.integration_runtime_credentials_operations import IntegrationRuntimeCredentialsOperations
from .operations.integration_runtime_connection_infos_operations import IntegrationRuntimeConnectionInfosOperations
from .operations.integration_runtime_auth_keys_operations import IntegrationRuntimeAuthKeysOperations
from .operations.integration_runtime_monitoring_data_operations import IntegrationRuntimeMonitoringDataOperations
from .operations.integration_runtime_status_operations import IntegrationRuntimeStatusOperations
...
from .operations.sql_pool_vulnerability_assesments_operations import SqlPoolVulnerabilityAssesmentsOperations
...
class SynapseManagementClient(SDKClient):
    ...
    :ivar integration_runtime_interactive_queries: IntegrationRuntimeInteractiveQueries operations
    :vartype integration_runtime_interactive_queries: azure.mgmt.synapse.operations.IntegrationRuntimeInteractiveQueriesOperations
    :ivar integration_runtime_operation_results: IntegrationRuntimeOperationResults operations
    :vartype integration_runtime_operation_results: azure.mgmt.synapse.operations.IntegrationRuntimeOperationResultsOperations
    :ivar integration_runtime_links: IntegrationRuntimeLinks operations
    :vartype integration_runtime_links: azure.mgmt.synapse.operations.IntegrationRuntimeLinksOperations
    ...
    :ivar integration_runtime_operation_status: IntegrationRuntimeOperationStatus operations
    :vartype integration_runtime_operation_status: azure.mgmt.synapse.operations.IntegrationRuntimeOperationStatusOperations
    ...
    :ivar sql_pool_vulnerability_assesments: SqlPoolVulnerabilityAssesments operations
    :vartype sql_pool_vulnerability_assesments: azure.mgmt.synapse.operations.SqlPoolVulnerabilityAssesmentsOperations
    ...
    def __init__(
        ...
        self.ip_firewall_rules = IpFirewallRulesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_runtime_interactive_queries = IntegrationRuntimeInteractiveQueriesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_runtime_operation_results = IntegrationRuntimeOperationResultsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_runtime_links = IntegrationRuntimeLinksOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_runtimes = IntegrationRuntimesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_runtime_node_ip_address = IntegrationRuntimeNodeIpAddressOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_runtime_operation_status = IntegrationRuntimeOperationStatusOperations(
            self._client, self.config, self._serialize, self._deserialize)
        ...
        self.sql_pool_connection_policies = SqlPoolConnectionPoliciesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.sql_pool_vulnerability_assesments = SqlPoolVulnerabilityAssesmentsOperations(
            self._client, self.config, self._serialize, self._deserialize)
