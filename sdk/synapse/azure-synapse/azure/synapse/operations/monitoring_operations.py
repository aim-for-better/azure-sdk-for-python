...
class MonitoringOperations(object):
    ...
    def get_history_server_data(
            self, workspace_name, pool_name, livy_id, app_id, attempt_id, api_version=None, custom_headers=None, raw=False, **operation_config):
    ...
    def get_spark_job_list(
            self, workspace_name, api_version=None, custom_headers=None, raw=False, **operation_config):
    ...
    def get_application_details(
            self, workspace_name, pool_name, livy_id, api_version=None, custom_headers=None, raw=False, **operation_config):
