...
class WorkspaceAclOperations(object):
    ...
    def get_access_control_info(
            self, workspace_name, artifact_type=None, artifact_name=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        resource = models.GetAccessControlInfoRequest(artifact_type=artifact_type, artifact_name=artifact_name)
