...
class SparkSessionOperations(object):
    ...
    def create_statement(
            self, workspace_name, spark_pool_name, session_id, code=None, kind=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        livy_request = models.LivyStatementRequestBody(code=code, kind=kind)
